...
class Test_Solution2 {
    ...
    void testShouldReturnTrueWhenStringsArePermutation() {
        ...
        assertTrue(Solution2.isPermutation(s, t));
    }
    ...
    void testShouldReturnFalseWhenStringsAreNotPermutation() {
        ...
        assertFalse(Solution2.isPermutation(s, t));
    }
    ...
    @ParameterizedTest
    @ArgumentsSource(Test_Solution2.BlankStringsArgumentsProvider.class)
    ...
    void testShouldThrowIllegalArgumentExceptionWhenAnyStringIsEmptyOrNull(String s, String t) {
        assertThrows(IllegalArgumentException.class, () -> Solution2.isPermutation(s, t));
    }
